...
@Client.on_message(filters.private & filters.incoming & filters.command(['helpvc']))
...
help_callback_filter = filters.create(lambda _, __, query: query.data.startswith('helpvc+'))
...
@Client.on_message(filters.command("helpvc") & ~filters.private & ~filters.channel)
